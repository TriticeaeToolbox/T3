...
if ($action == "list") {
    ...
    while ($row = mysqli_fetch_row($res)) {
        ...
        if ($row[2] == "genotype") {
            ...
            $data["additionalInfo"]["platform"] = $platform;
            $data["locationDbId"] = "";
            $data["locationName"] = "";
        } elseif ($row[2] == "phenotype") {
            $data["additionalInfo"]["platform"] = "";
    ...
    if ($type == "genotype") {
        ...
        $results["additionalInfo"]["platform"] = $platform;
        $results["location"]["locationDbId"] = "";
        ...
        $results["additionalInfo"]["platform"] = "";
        $results["location"]["locationDbId"] = $location;
        $results["location"]["name"] = $location;
    }
    if (preg_match("/[^,]+,[^,]+,([^,]+)/", $row[5], $match)) {
        $countryCode = $match[1];
    } else {
        $countryCode = "US";
    }
    $results["location"]["countryCode"] = $countryCode;
