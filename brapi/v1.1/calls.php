...
$ourcalls['germplasm'] = ['datatypes' => ['json'], 'methods' => ["GET", "POST"]];
$ourcalls['germplasm/{germplasmDbId}'] = ['datatypes' => ['json'], 'methods' => ["GET", "POST"]];
$ourcalls['germplasm/{germplasmDbId}/pedigree'] = ['datatypes' => ['json'], 'methods' => ["GET", "POST"]];
$ourcalls['germplasm/{germplasmDbId}/progeny'] = ['datatypes' => ['json'], 'methods' => ["GET", "POST"]];
