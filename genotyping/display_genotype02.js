...
{
    var url= 'genotyping/display_genotype.php?function=typeTabDelimiter'+ '&expuid=' + experiment_uid+ '&mm='+max_missing+'&mmaf='+min_maf;
...
function load_tab_delimiter_GBS(experiment_uid, max_missing, min_maf)
{
    ...
    var url='genotyping/display_genotype.php?function=typeTabDelimiterGBS'+ '&expuid=' + experiment_uid+ '&mm='+max_missing+'&mmaf='+min_maf;
    jQuery.ajax({
        type: "GET",
        url: "genotyping/display_genotype.php",
...
function mrefresh(trial_code)
{
    ...
    var url='genotyping/display_genotype.php?function=typeData'+ '&mm='+mm+'&mmaf='+mmaf+ '&trial_code='+trial_code;
    // Opens the url in the same window
            window.open(url, "_self");
}
