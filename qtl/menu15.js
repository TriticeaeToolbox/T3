...
function detailM(uid) {
    ...
    jQuery.ajax({
      type: "GET",
      url: php_self,
      data: "function=detail&pi=" + phenotype_items_str + "&uid=" + uid + "&assembly=" + assembly + "&method=" + method,
      success: function(data, textStatus) {
...
function detailG(gene) {
    ...
    jQuery.ajax({
      type: "GET",
      url: php_self,
      data: "function=detail&pi=" + phenotype_items_str + "&gene=" + gene + "&assembly=" + assembly + "&method=" + method,
      success: function(data, textStatus) {
        jQuery("#step3").html(data)
        document.title = title;
      },
...
function display_qtl() {
    ...
    if (phenotype_items_str == "") {
      ...
      jQuery.ajax({
        type: "GET",
        url: php_self,
        data: "function=displayQTL&sortby=" + sortBy + "&group=" + groupBy + "&method=" + method + "&assembly=" + assembly,
        success: function(data, textStatus) {
          jQuery("#step3").html(data)
          document.title = title;
        },
