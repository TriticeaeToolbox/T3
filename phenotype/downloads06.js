...
function update_phenotype_trial(options) {
	experiments_str = ""; 
	lines_str = "";
	$('#pheno_trial :selected').each(function(experiment) {
...
function update_line_trial(options) {
    ...
    experiments_str = ""; 
    phenotype_items_str = "";
    $('#line_trial :selected').each(function(experiment) {
        if (experiment.selected) {
            experiments_str += (experiments_str === "" ? "" : ",") + experiment.value;
        }
    });
...
function update_line_pheno(options) {
    phenotype_items_str = "";
    $('#line_pheno :selected').each(function(traits) {
        if (traits.selected) {
